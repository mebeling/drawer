...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "mebeling-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/ebelog"
  #   chef.validation_client_name = "ebelog-validator"
  #   chef.validation_key_path = ".chef/ebelog-validator.pem"
  # end
end
